...
const styles = StyleSheet.create({
  ...
  timeValue: { color: "#0F6E56", fontSize: fs(13), fontWeight: "700" },
  timeLabel: { color: "#0F6E56", fontSize: fs(8), marginTop: sp(1) },
  detailsGrid: {
    flexDirection: "row",
    gap: sp(8),
    borderTopWidth: 1,
  ...
  priceValue: { color: "#0F6E56", fontSize: fs(11), fontWeight: "700" },
